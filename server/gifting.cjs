...
- dm用(下書き): 120〜180字、カジュアル寄り、絵文字なし。本文の最後は「受け取り先は下のリンクからご入力ください」のように、システムが自動付与する受け取りリンクへ自然につなぐ一文で締める。URL自体は書かない。メールでの案内には言及しない（DMで完結させる）。アンバサダー/インセンティブは一言だけ軽く触れてよい
